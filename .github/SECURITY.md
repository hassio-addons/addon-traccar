...
[**Report a vulnerability**](https://github.com/hassio-addons/app-traccar/security/advisories/new)
...
- Issues in the Traccar server itself; please report those directly to the
  [Traccar project](https://github.com/traccar/traccar).
- Issues that require an already compromised Home Assistant instance, or
  physical or administrative access to the host running this app.
- Exposure resulting from deliberately publishing the app to the internet
  without SSL enabled, or from an insecure Home Assistant configuration.

## Scope

This security policy covers the Traccar app published from this repository,
including its container image and the configuration it ships.
